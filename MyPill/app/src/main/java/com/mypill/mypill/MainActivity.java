...
import com.mypill.mypill.Fragments.MenuDiario;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySelectedScreen(R.id.nav_diario);
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_hoy:
                fragment = new HoyFragment();
                break;
            case R.id.nav_tratamiento:
